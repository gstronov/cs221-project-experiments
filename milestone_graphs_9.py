...
if __name__ == '__main__':
    ...
    for j in range(2):
        ...
        for k in range(10):
            ...
            q = QLearningAlgorithm([0, 2, 3], discount = 1, featureExtractor = featureExtractorState, explorationProb=.9)
            #plays num_games number of games 
            for i in range(num_trained + 21):
                ...
                if i == num_trained + 20:
                    ...
                    print score_list
                    print float(sum(score_list))/len(score_list)
                    print str(cutoff)
